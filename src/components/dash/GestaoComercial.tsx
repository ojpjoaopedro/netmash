...
import { ShoppingCart, Target, Users, Award, Zap, Trophy } from "lucide-react";
...
export default function GestaoComercial({ metrs, lancs, saldoInicial }: { metrs: Metrica[]; lancs: Lancamento[]; saldoInicial: number }) {
