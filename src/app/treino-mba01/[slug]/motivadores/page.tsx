  ...
  const quadrantes: Quadrante[] = [
    {
      ...
      cor: AZUL,
      placeholder: 'Algo que você quer e ainda não tem — some ao que veio do To be / As is',
    ...
    },
    {
      ...
      cor: VERDE,
      placeholder: 'Algo bom que você já tem e não pode perder no meio do crescimento',
    ...
    },
    {
      ...
      cor: AMBAR,
      placeholder: 'Uma oportunidade que parece boa, mas você decide recusar desde já',
      derivados: [],
      origem: null,
      editarNaOrigem: null,
    },
    {
      ...
      cor: VERMELHO,
      placeholder: 'Algo que você tem hoje e precisa deixar de ter — dói, mas é preciso',
