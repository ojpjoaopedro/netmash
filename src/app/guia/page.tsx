  ...
  return (
    <div className="gu"
      ...
      <div className="gu-top">
        ...
        <a className="gu-skip" href="/dashboard/home">Pular ✕</a>
      </div>
      ...
      <div className="gu-nav">
        ...
        {i < N - 1
          ...
          : <a className="gu-next" href="/dashboard/home">Entrar →</a>}
      </div>
    </div>
  );
}
...
function render(s: Slide) {
  ...
  return (
    <>
      ...
      <a className="gu-cta" href="/dashboard/home">Entrar no painel <ArrowRight size={18} /></a>
    </>
  );
}
